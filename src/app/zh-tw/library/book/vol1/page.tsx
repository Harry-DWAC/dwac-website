...
export const metadata: Metadata = {
  title: '全球網絡法律彙編·第壹卷 | Digital World Arbitration Centre',
  description: '《全球網絡法律彙編》第壹卷收錄了數位法律領域的核心法律法規、典型案例和學術研究成果，為數位世界法律實踐提供權威參考。',
}
  ...
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-navy">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-slate-300 text-lg leading-relaxed">《全球網絡法律彙編》第壹卷收錄了數位法律領域的核心法律法規、典型案例和學術研究成果，為數位世界法律實踐提供權威參考。</p>
      </div>
    </div>
  )
}
