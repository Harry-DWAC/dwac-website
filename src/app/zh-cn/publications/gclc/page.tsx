...
const volI_CN: DownloadFile[] = [
  { name: 'Vol I 中文 — EPUB',       path: '/publications/gclc/vol-i/Global-Cyber-Law-Compendium-V1-CN-v25.epub', size: 440080,  fmt: 'EPUB' },
  { name: 'Vol I 中文 — HTML',       path: '/publications/gclc/vol-i/Global-Cyber-Law-Compendium-V1-CN-v25.html', size: 1337765, fmt: 'HTML' },
  { name: 'Vol I 中文 — Markdown',   path: '/publications/gclc/vol-i/Global-Cyber-Law-Compendium-V1-CN-v25.md',   size: 1235668, fmt: 'Markdown' },
]
...
const volII_CN: DownloadFile[] = [
  { name: 'Vol II 中文 — EPUB',      path: '/publications/gclc/vol-ii/Global-Cyber-Law-Compendium-V2_Complete-CN_Final-v33.epub', size: 643952,  fmt: 'EPUB' },
  { name: 'Vol II 中文 — HTML',      path: '/publications/gclc/vol-ii/Global-Cyber-Law-Compendium-V2_Complete-CN_Final-v33.html', size: 1999048, fmt: 'HTML' },
  { name: 'Vol II 中文 — Markdown',  path: '/publications/gclc/vol-ii/Global-Cyber-Law-Compendium-V2_Complete-CN_Final-v33.md',   size: 1861736, fmt: 'Markdown' },
]
...
const volIII_CN: DownloadFile[] = [
  { name: 'Vol III 中文 — EPUB',     path: '/publications/gclc/vol-iii/Global-Cyber-Law-Compendium-Volume-III-v2.2-CN.epub', size: 143991, fmt: 'EPUB' },
  { name: 'Vol III 中文 — HTML',     path: '/publications/gclc/vol-iii/Global-Cyber-Law-Compendium-Volume-III-v2.2-CN.html', size: 370816, fmt: 'HTML' },
  { name: 'Vol III 中文 — Markdown', path: '/publications/gclc/vol-iii/Global-Cyber-Law-Compendium-Volume-III-v2.2-CN.md',   size: 330156, fmt: 'Markdown' },
]
