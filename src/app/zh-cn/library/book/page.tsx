...
export const metadata: Metadata = {
  title: '专业图书馆 — DWAC',
  description: 'DWAC 专业图书馆——四卷数字世界法律、仲裁与人工智能治理权威出版物。',
}
...
export default function BookIndexPageZhCn() {
  return (
    <div className="flex flex-col">
      <section className="bg-gradient-navy py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gold-400 font-semibold mb-4 tracking-wide uppercase">DWAC 专业图书馆</p>
          <h1 className="font-serif text-4xl lg:text-5xl font-bold text-white mb-4">
            专业图书馆
          </h1>
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            四卷数字世界法律、仲裁、人工智能治理与全球仲裁规则的权威出版物。
          </p>
        </div>
      </section>
            ...
            {books.map((book) => (
              ...
              >
                ...
                <div className="px-6 pb-5 pt-2 border-t border-slate-100 mt-auto">
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">下载</p>
      ...
      <section className="py-12 bg-navy-900 text-center">
        <p className="text-slate-400 text-sm">
          全部卷册开放获取。免费下载、分享与引用，需注明来源为 DWAC。
        </p>
      </section>
    </div>
  )
