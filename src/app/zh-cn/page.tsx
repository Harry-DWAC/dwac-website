...
import { zhCnHomepageNews, monthLabel } from '@/lib/news'

const CATEGORY_ZH: Record<string, string> = { Institutional: '机构动态', Industry: '行业动态', Event: '活动', Publications: '出版物' }
